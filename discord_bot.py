    ...
    if data:
        ...
        if tournament_complete_count == len(data) and len(data) > 2:
            ...
            for user in complete_users[1:-1]:
                ...
                embed_message.add_field(name='Total Barons', value=complete_users[11])
                embed_message.add_field(name='Total Dragons', value=complete_users[12])
                embed_message.add_field(name='Total Turrets', value=complete_users[13])
